...
<body>
	...
	<b><div align=center class = "subtitle">Vanilla Rainbow Sprinkle</div></b>
	
	<div class = "cupcakesContainer">
		<div class="cupcake">
			<div> <img src="images/Cupcake2.jpeg" width = "400" height = "450"> </div>
		</div>
		
		<div class="cupcake">
			<div align = "center">
			This colorful treat is made with a moist vanilla base. It's topped with vanilla cream cheese frosting and filled with 
			sprinkles both inside and out.		
			</div>
			...
			<form method="post" action="cart.php?action=add&id=<?php echo $row2["ID"]; ?>">
				<label>Quantity</label>
				<br/>
				<input type="number" name="quantity" value = "1">
				<input type="hidden" name="hidden_name" value="<?php echo $row2["ProductName"]; ?>">
				<input type="hidden" name="hidden_price" value="<?php echo $row2["Price"]; ?>">
				<input type="hidden" name="hidden_inventory" value="<?php echo $row2["Inventory"]; ?>">
				<input type="submit" class = "submitButton" name="add" style="margin-top: 5px;" value="Add to Cart">
			</form>
			
			<p class = "stockStatus"><?php 
				if ($row2["Inventory"] < 10) {
					echo "Low In Stock";
				}
			?></p>

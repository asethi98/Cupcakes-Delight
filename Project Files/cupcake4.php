...
<body>
	...
	<b><div align=center class = "subtitle">Fruity Tooty</div></b>
	
	<div class = "cupcakesContainer">
		<div class="cupcake">
			<div> <img src="images/Cupcake4.jpeg" width = "400" height = "450"> </div>
		</div>
		
		<div class="cupcake">
			<div align = "center">
				This cupcake is made with a fresh fruit cake base and finished with vanilla whipped cream frosting. Its topped with
				green grapes, strawberries, and small chocolate rolls.
			</div>
			...
			<form method="post" action="cart.php?action=add&id=<?php echo $row4["ID"]; ?>">
				<label>Quantity</label>
				<br/>
				<input type="number" name="quantity" value = "1">
				<input type="hidden" name="hidden_name" value="<?php echo $row4["ProductName"]; ?>">
				<input type="hidden" name="hidden_price" value="<?php echo $row4["Price"]; ?>">
				<input type="hidden" name="hidden_inventory" value="<?php echo $row4["Inventory"]; ?>">
				<input type="submit" class = "submitButton" name="add" style="margin-top: 5px;" value="Add to Cart">
			</form>
			<p class = "stockStatus"><?php 
				if ($row4["Inventory"] < 10) {
					echo "Low In Stock";
				}
			?></p>
		</div>
